    ...
    const prompt = ai.definePrompt({
        ...
        **CRITICAL INSTRUCTIONS FOR YOUR ANALYSIS:**
        ...
        3.  **Provide Expanded Explanations**: In the 'analysis' for each suggestion, you MUST provide the "why" behind your numbers by referencing industry or science-backed data. Do not just state a number; explain why it's a good target for this specific user.
            ...
            *   **For "Build Muscle" - CRITICAL**: You MUST tailor your suggestion based on the user's gender and experience level.
                *   **For a Male User (Intermediate)**: A realistic rate of lean muscle gain is ~0.5 lbs per week. 'suggestedGoal': "Gain 5-6 lbs of lean mass over the next 3 months." 'analysis': "As an intermediate male lifter, gaining 0.5 lbs per week is a realistic rate for lean muscle growth without excessive fat gain. This target of 5-6 lbs over 12 weeks aligns perfectly with that evidence-based approach."
                *   **For a Female User (Intermediate)**: A realistic rate of lean muscle gain is ~0.5-1 lb per month. 'suggestedGoal': "Gain 2-3 lbs of lean mass over the next 3 months." 'analysis': "For an intermediate female lifter, a sustainable rate of muscle gain is about 0.5-1 lb per month. This target of 2-3 lbs over 3 months is an excellent, evidence-based goal that prioritizes lean growth."
