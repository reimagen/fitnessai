...
4.  **Detailed Workout Session Structure**: For *each* individual workout day or session detailed in the plan, you MUST structure it clearly with the following three components in order:
...
5.  **Overall Structure**: Ensure the explanations flow naturally into the detailed workout plan and that the entire response is coherent and easy to follow.
