    ...
    const prompt = ai.definePrompt({
        ...
        **CRITICAL INSTRUCTIONS FOR YOUR COMMENTARY:**
        ...
        6.  **Calibrate Your Tone to the Strength Level - CRITICAL**: Your interpretation of the trend percentages MUST be relative to the user's \`currentLevel\`.
            -   **For 'Beginner' or 'Intermediate' lifters: YOU MUST use strong, positive, and enthusiastic language. ** An e1RM or Volume increase of >10% is **EXCELLENT progress**. A 20-30% increase is a HUGE improvement. It is a failure to any trend >10% 'slight' or 'modest'.
